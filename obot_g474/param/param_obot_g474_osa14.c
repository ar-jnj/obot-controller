...
const volatile Param __attribute__ ((section ("flash_param"))) param_store = {
    ...
    .fast_loop_param.adc1_gain = 3.0/4096*3.8,  // A/count
    .fast_loop_param.adc2_gain = 3.0/4096*3.8),
    .fast_loop_param.adc3_gain = 3.0/4096*3.8, 
    ...
    .fast_loop_param.vbus_gain = 1.0/4096*(18.0+2.0)/2.0,
